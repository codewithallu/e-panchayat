...
th {
    ...
    color: white;
                                                        ...
                                                        String sql="select * from BIRTH where psts='p' and ssts='d'";
                                                        ...
                                                        while(rs.next()){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="birthissue.jsp?val=<%=rs.getString(1)%>">Generate Certificate</a></td>
                                                                <td><a href="birthreject.jsp?val=<%=rs.getString(1)%>">Reject</a></td>
