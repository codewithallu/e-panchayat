...
th {
    ...
    color: white;
                                                        ...
                                                        <table >
                                                            <th>Certificate NO</th><th>HusbandName</th><th>wifeName</th><th>Date</th><th>Day</th><th>place</th><th>Email</th>
                                                            <%
                                                        String sql="select * from MARRIAGE where asts='p'";
                                                        ...
                                                        while(rs.next()){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="marsec1.jsp?val=<%=rs.getString(1)%>">Send to secretary</a></td>
